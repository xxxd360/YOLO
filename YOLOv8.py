...
yolo = YOLO("models/yolov8n.pt", task="det")
result = yolo(source="D:\\pytorch.pycharm\\Resources/bus.jpg",save = True,conf=0.25,iou=0.7)
# conf 置信度阈值，默认0.25
# iou 交并比阈值，默认0.45
# save 保存检测结果，默认False
# results = yolo(source="screen")对屏幕
# results = yolo(source="0")#摄像头
...
# results = yolo(source="D:\pytorch.pycharm\Resources\something.mp4",show=True,conf=0.5,iou=0.8)
